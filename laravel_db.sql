...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Jul 2019 pada 15.50
...
--
CREATE DATABASE IF NOT EXISTS `apriori_toko` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `apriori_toko`;
...
--
-- Indeks untuk tabel `transaksi_old`
--
...
--
-- AUTO_INCREMENT untuk tabel `transaksi_old`
--
ALTER TABLE `transaksi_old`
...
(8, 'Pemain Golf KALAH dari Pemain Catur!! (Wtf!!??)', 'Olahraga', '2016_11_13_18_08_19_p9220572.jpg', '<p>The PHP development team announces the immediate availability of PHP 7.1.0 Release Candidate 6. This release is the sixth and final release candidate for 7.1.0. All users of PHP are encouraged to test this version carefully, and report any bugs and incompatibilities in the bug tracking system.</p><p>The PHP development team announces the immediate availability of PHP 7.1.0 Release Candidate 5. This release is the fifth release candidate for 7.1.0. All users of PHP are encouraged to test this version carefully, and report any bugs and incompatibilities in the bug tracking system.</p>', 'Pemain-Golf-KALAH-dari-Pemain-Catur!!-(Wtf!!)', 261, '2016-12-03 11:08:19', '2019-07-15 07:28:36'),
(9, 'Apa yang Terjadi Jika Perang Dunia Ketiga?', 'Nasional, Health', '2016_11_14_09_54_08_Selection_004.png', '<p>Akankah anak SMK menyerang???? &nbsp;Masih misteri!</p>', 'Apa-yang-Terjadi-Jika-Perang-Dunia-Ketiga', 164, '2016-11-13 11:30:08', '2019-07-15 07:24:54'),
(10, 'Aksi Damai', 'Nasional', '2016_12_06_10_09_30_Selection_003.png', '<p>Aksi damai berjalan lancar.</p>', 'Aksi-Damai', 4, '2016-12-06 03:09:30', '2019-07-15 10:59:33');
...
(1, 'Admin Portal Berita', 'admin@portal.com', 'admin@portal.com', 'profile.png', '', '0000-00-00', '', 'UZdCNUyv1rYiO3yKooxMhRPTg4OJP2HNI6FLyBA5TEPsY0jfQBaMaIxGaPZf', '2016-11-12 04:33:38', '2016-12-03 21:12:12'),
...
(4, 'Admin', 'fifidwi14@gmail.com', 'fifidwi14@gmail.com', 'profile.png', NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'fifi', 'fifi@gmail.com', 'fifi@gmail.com', 'profile.png', NULL, NULL, NULL, NULL, NULL, NULL);
...
(20, '2019-07-15 04:51:49', '2019-07-15 04:51:49'),
(21, '2019-07-15 05:18:33', '2019-07-15 05:18:33'),
(22, '2019-07-15 07:18:09', '2019-07-15 07:18:09'),
(23, '2019-07-15 07:24:54', '2019-07-15 07:24:54'),
(24, '2019-07-15 07:25:06', '2019-07-15 07:25:06'),
(25, '2019-07-15 07:25:11', '2019-07-15 07:25:11'),
(26, '2019-07-15 07:25:11', '2019-07-15 07:25:11'),
(27, '2019-07-15 07:28:36', '2019-07-15 07:28:36'),
(28, '2019-07-15 08:19:38', '2019-07-15 08:19:38'),
(29, '2019-07-15 10:59:33', '2019-07-15 10:59:33');
...
-- Database: `laravel_db`
--
CREATE DATABASE IF NOT EXISTS `laravel_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `laravel_db`;
...
--
-- Struktur dari tabel `karyawan_tbl`
--
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
(1, '2019_05_13_041836_create_table_karyawan', 1),
(2, '2019_05_13_042155_create_table_user', 1),
(3, '2019_05_13_042233_create_table_blog', 1),
(4, '2019_07_14_064104_create_karyawans_table', 1),
(5, '2019_07_14_105939_create_tabel_k_s_table', 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tabel_k_s`
--

CREATE TABLE `tabel_k_s` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nama` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jenis_kelamin` enum('L','P') COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `blog_tbl`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `blog_tbl_id_unique` (`id`);
...
--
-- Indeks untuk tabel `karyawan_tbl`
--
ALTER TABLE `karyawan_tbl`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `karyawan_tbl_id_unique` (`id`);
...
--
-- Indeks untuk tabel `tabel_k_s`
--
ALTER TABLE `tabel_k_s`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `user_tbl`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `user_tbl_id_unique` (`id`),
...
--
-- AUTO_INCREMENT untuk tabel `karyawan_tbl`
--
ALTER TABLE `karyawan_tbl`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `tabel_k_s`
--
ALTER TABLE `tabel_k_s`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
-- Database: `myattend`
--
CREATE DATABASE IF NOT EXISTS `myattend` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `myattend`;
...
(9, 2, '2017-10-02', '15:35:02', '15:35:16', 'besok agak telat', '2017-10-02 08:35:02', '2017-10-02 08:35:16'),
(10, 1, '2017-10-02', '15:42:59', '15:43:02', '', '2017-10-02 08:42:59', '2017-10-02 08:43:02');
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
(1, '2017_10_01_162650_CreateTableAbsen', 1);
...
(2, 'DONI AS\'RUL AFANDI', 'doniasrulafandi@gmail.com', '$2y$10$5sK7lM2tCUw2c8eY8AkE8e/9Cun6lhloKbyWcyipu1qqt9X1PSJLy', 'it8FiEGr5dbBsYh04g8P3UMOlSFDxTLGGXbtCQg1bIUYyGRKomn8trRVmEX5', '2017-10-01 22:39:03', '2017-10-02 01:42:39');
...
('root', '[{\"db\":\"ujikom\",\"table\":\"users\"},{\"db\":\"db_portal\",\"table\":\"users\"},{\"db\":\"db_portal\",\"table\":\"password_resets\"}]');
...
('root', '2019-07-15 13:45:57', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\"}');
...
(11, 'Aldi', 'aldi@gmail.com', '$2y$10$w6UqafOVptikTXXiQhISZe5WBmiMDHFMv0cbNWJzxYAnXvhUbhXyu', 'admin', NULL, '2019-07-14 21:01:30', '2019-07-14 21:01:30'),
(12, 'fifi', 'fifi@gmail.com', 'fifi@gmail.com', 'admin', NULL, NULL, NULL);
...
--
-- Indeks untuk tabel `kategori_lemburs`
--
...
--
-- Indeks untuk tabel `tunjangan_pegawais`
--
...
--
-- AUTO_INCREMENT untuk tabel `kategori_lemburs`
--
ALTER TABLE `kategori_lemburs`
...
--
-- AUTO_INCREMENT untuk tabel `tunjangan_pegawais`
--
ALTER TABLE `tunjangan_pegawais`
