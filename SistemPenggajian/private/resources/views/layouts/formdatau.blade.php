...
<head>
  ...
  <title>SIDK | General Form Elements</title>
...
<!-- <div class="wrapper"> -->
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SIDK</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Fifi Dwi Ariani</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Daftar Karyawan</span>
            <span class="pull-right-container">
              <!-- <i class="fa fa-angle-left pull-right"></i> -->
            </span>
          </a>
        ...
        <li> -->
          <a href="../widgets.html">
            <i class="fa fa-th"></i> <span>Data User Login</span>
            <span class="pull-right-container">
              <!-- <small class="label pull-right bg-green">new</small> -->
            </span>
          </a>
        ...
        <li class="treeview active">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Data Prestasi Pegawai</span>
            <span class="pull-right-container">
             <!--  <i class="fa fa-angle-left pull-right"></i> -->
            </span>
          </a>
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputUn" class="col-sm-2 control-label">Username</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputUn" placeholder="Username">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputNt" class="col-sm-2 control-label">No Telp</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNt" placeholder="No Telp">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputJK" class="col-sm-2 control-label">Status</label>
                ...
                <!-- <div class="form-group">
                  <label for="inputNp" class="col-sm-2 control-label">Nama Prestasi</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNp" placeholder="Nama Prestasi">
                  </div>
                </div> -->
                <!-- <div class="form-group">
