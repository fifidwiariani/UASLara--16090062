  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Daftar Karyawan</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          ...
          <div class="card mt-5">
            <div class="card-body">
              <div class = "form-group">
                <a href="{{route('formkaryawan')}}" class="btn btn-primary">Tambah</a>         
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  <td>12345</td>
                  <td>Fifi Dwi Ariani</td>
                  <td>Tegal,13 April 1997</td>
                  <td>Perempuan</td>
                  <td>085674318965</td>
                  <td>Sekertaris</td>
