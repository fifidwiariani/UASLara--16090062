  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="{{ route('cruddp') }}">
            <i class="fa fa-edit"></i> <span>Data Prestasi Karyawan</span>
            <span class="pull-right-container">
              <!-- <i class="fa fa-angle-left pull-right"></i> -->
            </span>
          </a>
        ...
        <!-- <section class="col-lg-7 connectedSortable"> -->
          ...
          <!-- <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box"> -->
              <!-- chat item -->
              <!-- <div class="item">
                <img src="{{asset('public/adminlte/dist/img/user4-128x128.jpg')}}" alt="user image" class="online"> -->
              ...
              <!-- chat item -->
              <!-- <div class="item">
                <img src="{{asset('public/adminlte/dist/img/user3-128x128.jpg')}}" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <!-- <div class="item">
                <img src="{{asset('public/adminlte/dist/img/user2-160x160.jpg')}}" alt="user image" class="offline">
